                        ...
                        <article className="card-body" >
                            <form style={{ margin: "0px 20px 0px 15px" }}>
                                ...
                                <div className="form-group" >
                                    ...
                                    <button type="button" onClick={() => { sessionStorage.removeItem('devicetaskSno'); window.location.href = '/TotalDeviceTask' }} className="btn btn-secondary mr-4 float-right mb-4 mt-3">Cancel</button>
                                </div>
                            </form>
                        </article>
                    </div>
