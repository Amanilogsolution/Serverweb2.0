                        ...
                        <div className='main_container' >
                            <div className='m-auto' style={{ overflow: "hidden", width: "97%" }}>
                                <div className=' d-flex justify-content-between mx-5 pt-4 pb-3' >
                                    <h2><span className='page-type-head1'>Service Group <MdOutlineKeyboardArrowRight /></span> <span className='page-type-head1'>Total Service Group</span> </h2>
                                    <button className='btn btn-sm btn-voilet ' onClick={e => { e.preventDefault(); window.location.href = './AddServiceGroup' }} >Add Service Group +</button>
                                </div>
                                <div >
