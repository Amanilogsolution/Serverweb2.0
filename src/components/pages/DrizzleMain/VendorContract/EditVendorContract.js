...
function EditVendorCode() {
    ...
    const handleaddinsert = async (e) => {
        ...
        if (!vendor_code || !vendor_name || !comp_addr1 || !comp_city || !comp_state || !comp_pincode || !comp_email) {
            ...
            const result = await UpdateVendorCode(sno, vendor_code, comp_addr1, comp_addr2, comp_city, comp_state, comp_pincode, comp_gst, comp_website, comp_email, vendor_portal, user_id);
            console.log(result)
