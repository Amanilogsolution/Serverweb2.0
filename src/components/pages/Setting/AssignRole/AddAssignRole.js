                    ...
                    <Sidebar >
                        ...
                        <div className='main_container pb-2' >
                            <div className=' d-flex justify-content-between mx-5 pt-4 pb-3'>
                                <h2><span className='page-type-head1'>Assign Role<MdOutlineKeyboardArrowRight /></span> <span className='page-type-head2'>Add Assign Role</span> </h2>
                            ...
                            <div className="card m-auto" style={{ width: "50%" }}>
                                ...
                                <article className="card-body" >
                                    ...
                                    <div className='row'>
                                        ...
                                        <div style={{ display:"none"}} id="tableToggle">
